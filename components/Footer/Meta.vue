...
<template>
  <section class="footer__meta">
    ...
    <p
      v-if="contactDetails?.singleLineAddress && contactDetails.singleLineAddress.length > 0"
      class="footer__meta-address"
      v-html="contactDetails.singleLineAddress"
    />

    <nav v-if="contactDetails?.linkList && contactDetails.linkList.length > 0" class="footer__meta-contact">
      <NuxtLink
    ...
    <nav v-if="socialMediaLinks && socialMediaLinks.length > 0" class="footer__meta-social">
      <NuxtLink
