    ...
    <section class="header__top">
        <div class="header__top-container">
            <div class="header__top-left">
                <nav v-if="contactDetails?.linkList && contactDetails.linkList.length > 0" class="header__top-left-nav">
                    <p
            ...
            <div class="header__top-right">
                <nav v-if="socialMediaLinks && socialMediaLinks.length > 0" class="header__top-right-nav">
                    <NuxtLink
